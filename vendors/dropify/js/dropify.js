...
;(function(root, factory) {
  ...
  function Dropify(element, options) {
      ...
      var defaults = {
          ...
          error: {
              'fileSize': 'El archivo es demasiado grande, ({{ value }} máximo).',
              ...
              'minHeight': 'El alto de la imagen es muy pequeño, ({{ value }}}px mínimo).',
              'maxHeight': 'El alto de la imagen es muy grande, ({{ value }}px máximo).',
